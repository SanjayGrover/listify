...
const styles = {
  ...
  header: { display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem 2rem', backgroundColor: 'var(--bg-header)', boxShadow: `0 1px 4px var(--shadow)`, flexWrap: 'wrap' },
  backBtn: { padding: '0.4rem 0.8rem', borderRadius: '6px', border: '1px solid var(--border-color)', cursor: 'pointer', backgroundColor: 'var(--bg-card)', color: 'var(--text-primary)' },
  title: { margin: 0, cursor: 'pointer', fontSize: '1.4rem', color: 'var(--text-primary)' },
  titleEdit: { display: 'flex', gap: '0.5rem', alignItems: 'center' },
  titleInput: { padding: '0.4rem 0.75rem', borderRadius: '6px', border: '1px solid var(--border-color)', fontSize: '1.1rem', backgroundColor: 'var(--bg-input)', color: 'var(--text-primary)' },
  saveBtn: { padding: '0.4rem 0.8rem', borderRadius: '6px', border: 'none', backgroundColor: 'var(--accent)', color: '#fff', cursor: 'pointer' },
  cancelBtn: { padding: '0.4rem 0.8rem', borderRadius: '6px', border: '1px solid var(--border-color)', cursor: 'pointer', backgroundColor: 'var(--bg-card)', color: 'var(--text-primary)' },
  shareToggleBtn: { marginLeft: 'auto', padding: '0.4rem 0.8rem', borderRadius: '6px', border: '1px solid var(--accent)', color: 'var(--accent-text)', backgroundColor: 'var(--bg-card)', cursor: 'pointer' },
  ...
  addBtn: { padding: '0.75rem 1.25rem', borderRadius: '6px', border: 'none', backgroundColor: 'var(--accent)', color: '#fff', fontSize: '1rem', cursor: 'pointer' },
  ...
  itemCard: { backgroundColor: 'var(--bg-card)', borderRadius: '8px', padding: '1rem', boxShadow: `0 2px 6px var(--shadow)` },
  itemRow: { display: 'flex', alignItems: 'center', gap: '0.75rem' },
  dragHandle: { cursor: 'grab', fontSize: '1.2rem', color: 'var(--text-muted)', userSelect: 'none' },
  checkbox: { width: '18px', height: '18px', cursor: 'pointer', accentColor: 'var(--accent)' },
  itemText: { flex: 1, fontSize: '1rem', color: 'var(--text-primary)' },
  itemActions: { display: 'flex', gap: '0.5rem' },
  subBtn: { padding: '0.3rem 0.6rem', borderRadius: '6px', border: '1px solid var(--border-color)', cursor: 'pointer', backgroundColor: 'var(--bg-card)', color: 'var(--text-primary)', fontSize: '0.85rem' },
  deleteBtn: { background: 'none', border: 'none', cursor: 'pointer', fontSize: '1rem' },
  subItemSection: { marginTop: '0.75rem', paddingLeft: '1.5rem', borderLeft: '2px solid var(--sub-border)', display: 'flex', flexDirection: 'column', gap: '0.5rem' },
  subItemRow: { display: 'flex', alignItems: 'center', gap: '0.75rem' },
  subAddForm: { display: 'flex', gap: '0.5rem', marginTop: '0.5rem' },
  subInput: { flex: 1, padding: '0.5rem', borderRadius: '6px', border: '1px solid var(--border-color)', fontSize: '0.9rem', backgroundColor: 'var(--bg-input)', color: 'var(--text-primary)' },
  subAddBtn: { padding: '0.5rem 0.75rem', borderRadius: '6px', border: 'none', backgroundColor: 'var(--accent)', color: '#fff', fontSize: '0.9rem', cursor: 'pointer' },
  errorBanner: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'var(--error-bg)', border: '1px solid var(--error-border)', color: 'var(--error-text)', padding: '0.75rem 1rem', borderRadius: '8px', marginBottom: '1rem' },
  errorClose: { background: 'none', border: 'none', color: 'var(--error-text)', fontSize: '1rem', cursor: 'pointer' },
};
